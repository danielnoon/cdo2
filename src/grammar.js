...
var grammar = {
    ...
    {"name": "logical", "symbols": ["operand", "_", {"literal":"and"}, "_", "operand"], "postprocess": ([left,, op,, right]) => ({ left, op: "AND", right })},
    {"name": "logical", "symbols": ["operand", "_", {"literal":"or"}, "_", "operand"], "postprocess": ([left,, op,, right]) => ({ left, op: "OR", right })},
    {"name": "logical", "symbols": [{"literal":"not"}, "_", "operand"], "postprocess": ([,,operand]) => ({ op: "NOT", operand })},
